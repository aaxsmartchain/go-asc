...
// ValidatorsABI return system contract validators ABI
func (api *API) ValidatorsABI() string {
	return validatorsInteractiveABI
}

// PunishABI return system contract punish ABI
func (api *API) PunishABI() string {
	return punishInteractiveABI
}

// ProposalABI return system contract proposal ABI
func (api *API) ProposalABI() string {
	return proposalInteractiveABI
}
